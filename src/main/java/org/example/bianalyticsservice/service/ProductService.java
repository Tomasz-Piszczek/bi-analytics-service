...
public class ProductService {
    ...
    public Page<ProductDto> findAllProductsWithResources(Pageable pageable, boolean filterQuantity) {
        return productRepository.findAllProductsWithResources(pageable, filterQuantity);
    }
}